...
if not TELEGRAM_BOT_TOKEN:
    ...
    raise ValueError("خطأ: لم يتم العثور على TELEGRAM_TOKEN! يرجى إعداده كمتغير بيئة آمن.")
...
async def handle_link(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        audio_buttons = [InlineKeyboardButton(a['label'], callback_data=json.dumps({'type': 'audio', 'id': a['id']})) for a in audios]
